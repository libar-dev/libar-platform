 ...
 * @architect-uses EmittedAgentCommand
 * @architect-used-by EventHandler, CommandOrchestrator, AdminUI
 * @architect-target platform-core/src/agent/component/commands.ts
 *
