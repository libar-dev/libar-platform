 ...
 * @architect-uses AgentDeadLetter
 * @architect-used-by EventHandler, AdminUI, OnCompleteHandler
 * @architect-target platform-core/src/agent/component/deadLetters.ts
 *
