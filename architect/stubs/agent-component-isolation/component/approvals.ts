 ...
 * @architect-infra
 * @architect-implements AgentBCComponentIsolation
 * @architect-uses PendingApproval, HumanInLoopConfig
 * @architect-used-by EventHandler, ApprovalWorkflow, AdminUI
 * @architect-target platform-core/src/agent/component/approvals.ts
 *
