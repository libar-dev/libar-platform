 ...
 * @architect-used-by AgentCheckpoint, AgentAuditEvent, AgentDeadLetter, AgentCommand, PendingApproval
 * @architect-target platform-core/src/agent/component/schema.ts
 *
