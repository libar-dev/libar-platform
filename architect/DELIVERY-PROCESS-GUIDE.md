...
This repo uses `@architect-*` tags (DDD_ES_CQRS_PRESET).

| Placeholder in Package Docs | This Repo               |
| --------------------------- | ----------------------- |
| `@<prefix>-pattern`         | `@architect-pattern`    |
| `@<prefix>-status`          | `@architect-status`     |
| `@<prefix>-phase`           | `@architect-phase`      |
| `@<prefix>-depends-on`      | `@architect-depends-on` |
