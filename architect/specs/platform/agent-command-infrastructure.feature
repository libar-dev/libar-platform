  ...
  **Migration Notes — Inline onEvent to Pattern-Based Architecture:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Agent command router | complete | @libar-dev/platform-core/src/agent/command-router.ts | Yes | unit |
      | CommandOrchestrator integration for agent commands | complete | @libar-dev/platform-core/src/agent/command-bridge.ts | Yes | unit |
      | Agent lifecycle FSM | complete | @libar-dev/platform-core/src/agent/lifecycle-fsm.ts | Yes | unit |
      | StartAgent command handler | complete | @libar-dev/platform-core/src/agent/lifecycle-handlers.ts | Yes | unit |
      | PauseAgent command handler | complete | @libar-dev/platform-core/src/agent/lifecycle-handlers.ts | Yes | unit |
      | ResumeAgent command handler | complete | @libar-dev/platform-core/src/agent/lifecycle-handlers.ts | Yes | unit |
      | StopAgent command handler | complete | @libar-dev/platform-core/src/agent/lifecycle-handlers.ts | Yes | unit |
      | ReconfigureAgent command handler | complete | @libar-dev/platform-core/src/agent/lifecycle-handlers.ts | Yes | unit |
      | Unified pattern executor | complete | @libar-dev/platform-core/src/agent/pattern-executor.ts | Yes | unit |
      | Pattern registry | complete | @libar-dev/platform-core/src/agent/pattern-registry.ts | Yes | unit |
      | AgentBCConfig patterns field | complete | @libar-dev/platform-core/src/agent/types.ts | Yes | unit |
