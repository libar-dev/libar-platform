...
@foundation
@architect-pattern:RepoLevelDocsGeneration
@architect-status:completed
@architect-unlock-reason:Path-update-after-submodule-migration-PR-120
@architect-phase:100
@architect-quarter:Q1-2026
@architect-effort:4h
@architect-effort-actual:4h
@architect-depends-on:ProcessMetadataExpansion
@architect-product-area:DeliveryProcess
@architect-business-value:enable-multi-source-documentation-generation
