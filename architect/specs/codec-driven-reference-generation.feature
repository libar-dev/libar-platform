...
@architect-business-value:eliminate-recipe-files-via-codec-composition
@architect-priority:high
@architect-executable-specs:deps-packages/architect/tests/features/behavior/reference-generation
@architect-unlock-reason:Fix-deliverable-status-Done-to-canonical-complete
