...
@foundation
@architect-pattern:ProcessMetadataExpansion
  ...
  **Solution:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Risk tag in registry | complete | No | architect/tag-registry.json |
      | Effort-actual tag in registry | complete | No | architect/tag-registry.json |
      | Workflow tag in registry | complete | No | architect/tag-registry.json |
