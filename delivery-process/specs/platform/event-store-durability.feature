...
@libar-docs-unlock-reason:adding-missing-tests-not-scope-creep
@libar-docs-phase:18b-0
@libar-docs-effort:1w
@libar-docs-product-area:Platform
@libar-docs-business-value:guaranteed-event-capture-and-audit-trail
@libar-docs-depends-on:EventStoreFoundation,DurableFunctionAdapters,WorkpoolPartitioningStrategy
@libar-docs-enables:SagaEngine,ProjectionRebuilder,CrossContextIntegration,AuditCompliance
@libar-docs-executable-specs:platform-core/tests/features/behavior/event-store-durability
@libar-docs-see-also:EventSubscription,EventVersioning,ProductionHardening,AgentAsBoundedContext
@libar-docs-api-ref:libar-dev/platform-core/src/durability/outbox.ts,libar-dev/platform-core/src/durability/types.ts,libar-dev/platform-core/src/durability/idempotentAppend.ts
  ...
  **Relationship to Other Specs:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Outbox types and interfaces | complete | @libar-dev/platform-core/src/durability/types.ts | Yes | unit |
      | createOutboxHandler factory | complete | @libar-dev/platform-core/src/durability/outbox.ts | Yes | unit |
      | Idempotent append helper | complete | @libar-dev/platform-core/src/durability/idempotentAppend.ts | Yes | unit |
      | Durable append action wrapper | complete | @libar-dev/platform-core/src/durability/durableAppend.ts | Yes | unit |
      | Durable event publisher | complete | @libar-dev/platform-core/src/durability/publication.ts | Yes | unit |
      | Intent/completion pattern helpers | complete | @libar-dev/platform-core/src/durability/intentCompletion.ts | Yes | unit |
      | Poison event handler | complete | @libar-dev/platform-core/src/durability/poisonEvent.ts | Yes | unit |
      | idempotencyKey field + index on events | complete | @libar-dev/platform-store/src/component/schema.ts | No | - |
      | getByIdempotencyKey query | complete | @libar-dev/platform-store/src/component/lib.ts | No | - |
      | eventPublications tracking table | complete | examples/order-management/convex/schema.ts | No | - |
      | poisonEvents tracking table | complete | examples/order-management/convex/schema.ts | No | - |
      | eventAppendPool Workpool | complete | examples/order-management/convex/convex.config.ts | No | - |
      | publicationPool Workpool | complete | examples/order-management/convex/convex.config.ts | No | - |
      | Append failure dead letters | complete | examples/order-management/convex/eventStore/deadLetters.ts | Yes | integration |
      | Publication dead letters | complete | examples/order-management/convex/integration/deadLetters.ts | Yes | integration |
      | eventAppendDeadLetters table | complete | examples/order-management/convex/schema.ts | No | - |

  # ===========================================================================
  # RULE 1: Outbox Pattern for Action Results
  # ===========================================================================

  Rule: Action results are captured as events via onComplete mutation
    ...
    **Verified by:** External API success is captured as event, External API failure is captured as event, onComplete mutation failure is retried
    ...
    Scenario: External API success is captured as event
    ...
    Scenario: External API failure is captured as event
      Given an order "ord-123" requiring payment
    ...
    @acceptance-criteria @validation
    Scenario: onComplete mutation failure is retried
    ...
    Scenario: Idempotent append prevents duplicate events
  ...
  # ===========================================================================
  # RULE 2: Idempotent Event Append
  # ===========================================================================

  Rule: Event append is idempotent using idempotency keys
  ...
  # ===========================================================================
  # RULE 3: Durable Cross-Context Event Publication
  # ===========================================================================

  Rule: Cross-context events use Workpool-backed publication with tracking
    ...
    **Verified by:** Event is delivered to all target contexts, Failed delivery is retried, Max retries exceeded creates dead letter
    ...
    @acceptance-criteria @happy-path
    Scenario: Event is delivered to all target contexts
    ...
    @acceptance-criteria @validation
    Scenario: Max retries exceeded creates dead letter
    ...
    @acceptance-criteria @happy-path
    Scenario: Publication status is queryable
  ...
  # ===========================================================================
  # RULE 4: Intent/Completion Event Pattern
  # ===========================================================================

  Rule: Long-running operations bracket with intent and completion events
    ...
    **Verified by:** Intent and completion events bracket operation, Timeout detects incomplete operation, Reconciliation query finds orphaned intents
    ...
    @acceptance-criteria @happy-path
    Scenario: Intent and completion events bracket operation
    ...
    @acceptance-criteria @validation
    Scenario: Timeout detects incomplete operation
    ...
    @acceptance-criteria @edge-case
    Scenario: Idempotent timeout handler
    ...
    @acceptance-criteria @validation
    Scenario: Reconciliation query finds orphaned intents
  ...
  # ===========================================================================
  # RULE 5: Durable Append via Workpool Actions
  # ===========================================================================

  Rule: Failed event appends are recovered via Workpool actions
    ...
    **Verified by:** Append succeeds on first attempt, Append retried after failure, Exhausted retries create dead letter
    ...
    @acceptance-criteria @happy-path
    Scenario: Append succeeds on first attempt
    ...
    @acceptance-criteria @validation
    Scenario: Append retried after transient failure
    ...
    @acceptance-criteria @validation
    Scenario: Exhausted retries create dead letter
  ...
  # ===========================================================================
  # RULE 6: Poison Event Handling
  # ===========================================================================

  Rule: Malformed events are quarantined after repeated failures
    ...
    **Verified by:** Event quarantined after repeated failures, Quarantined events skipped in processing
    ...
    @acceptance-criteria @validation
    Scenario: Event quarantined after repeated failures
    ...
    @acceptance-criteria @validation
    Scenario: Quarantined events skipped in processing
    ...
    @acceptance-criteria @happy-path
    Scenario: Recovered event can be reprocessed
  ...
  # ===========================================================================
  # RULE 7: Publication Dead Letter Management
  # ===========================================================================

  Rule: Failed publications are tracked and recoverable
    ...
    **Verified by:** Dead letter created after max retries, Admin can retry dead letter, Dead letter stats show context-specific issues
    ...
    @acceptance-criteria @happy-path
    Scenario: Dead letter created after max retries
    ...
    @acceptance-criteria @happy-path
    Scenario: Admin can retry dead letter
    ...
    @acceptance-criteria @validation
    Scenario: Dead letter stats show context-specific issues
