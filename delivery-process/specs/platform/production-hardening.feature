...
@libar-docs-phase:18b
@libar-docs-effort:3w
@libar-docs-product-area:Platform
@libar-docs-business-value:operational-reliability-and-system-observability
@libar-docs-depends-on:ReactiveProjections,DurableFunctionAdapters
@libar-docs-executable-specs:platform-core/tests/features/behavior/production-hardening
  ...
  **Note:** This is Phase 18b (WIP). Phase 18a (DurableFunctionAdapters) covers rate limiting
  ...
  Rule: Admin tooling enables operational tasks
    ...
    **DLQ Population via Workpool onComplete:**
    ...
    @acceptance-criteria
    Scenario: Durable function run diagnostics
  ...
  # ===========================================================================
  # RULE 6: Durable Function Integration
  # ===========================================================================
  ...
  Rule: Durable functions provide reliable execution patterns
    ...
    **Dead Letter Queue Retry with Action Retrier:**
    ...
    @acceptance-criteria @validation
    Scenario: Durable function calls propagate trace context
