...
@libar-docs-pattern:AdminToolingConsolidation
@libar-docs-status:roadmap
@libar-docs-phase:18b-4
@libar-docs-effort:3d
@libar-docs-product-area:Platform
@libar-docs-business-value:unified-operations-interface
@libar-docs-depends-on:EventReplayInfrastructure,HealthObservability,CircuitBreakerPattern
@libar-docs-executable-specs:platform-core/tests/features/behavior/admin-tooling
Feature: Admin Tooling Consolidation - Unified Operations Interface
  ...
  **Design Principle:** Saga admin remains at `convex/sagas/admin.ts` because sagas
  ...
  Rule: Admin directory provides unified location for operational endpoints
    ...
    **Migration Strategy:**
    ...
    Scenario: Admin directory is created with correct structure
    ...
    Scenario: Backward compatibility for DLQ imports
  ...
  # ===========================================================================
  # RULE 2: Dead Letter Queue Management
  # ===========================================================================

  Rule: DLQ endpoints provide inspection, retry, and ignore operations
    ...
    **Enhanced DLQ Operations:**
    ...
    @acceptance-criteria @happy-path
    Scenario: Get dead letter statistics
    ...
    @acceptance-criteria @happy-path
    Scenario: Bulk retry pending dead letters
  ...
  # ===========================================================================
  # RULE 3: Event Flow Diagnostics
  # ===========================================================================

  Rule: Event flow trace enables debugging across the command-event-projection chain
    ...
    **Trace Query:**
    ...
    @acceptance-criteria @happy-path
    Scenario: Trace complete event flow
    ...
    @acceptance-criteria @validation
    Scenario: Trace shows failure point
  ...
  # ===========================================================================
  # RULE 4: System State Snapshot
  # ===========================================================================

  Rule: System state snapshot provides full health picture
    ...
    **Snapshot Query:**
    ...
    @acceptance-criteria @happy-path
    Scenario: System state provides complete overview
  ...
  # ===========================================================================
  # RULE 5: Durable Function Inspection
  # ===========================================================================

  Rule: Durable function queries enable Workpool and Workflow debugging
    ...
    **Durable Function Queries:**
    ...
    @acceptance-criteria @happy-path
    Scenario: Query Workpool item status
    ...
    @acceptance-criteria @happy-path
    Scenario: Query Workflow execution with steps
    ...
    @acceptance-criteria @validation
    Scenario: Query non-existent durable function
  ...
  # ===========================================================================
  # RULE 6: Admin Authorization
  # ===========================================================================

  Rule: Admin endpoints require authorization
