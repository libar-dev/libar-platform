...
@libar-docs-pattern:IntegrationPatterns21a
@libar-docs-status:roadmap
@libar-docs-phase:21
@libar-docs-effort:1w
@libar-docs-product-area:Platform
@libar-docs-depends-on:EcstFatEvents
...
Feature: Integration Patterns (21a) - Registry & Core Patterns
  ...
  **Relationship to Phase 21b:** This spec provides foundational registry infrastructure.
  ...
  Rule: Context Map documents BC relationships
    ...
    **Verified by:** Context Map shows BC topology, Register Partnership relationship,
    ...
    Scenario: Context Map shows BC topology
  ...
  # ============================================================================
  # RULE 2: Published Language Defines Stable Contracts
  # ============================================================================

  Rule: Published Language defines stable contracts
    ...
    **Verified by:** Integration event uses Published Language, Event tagging for routing and DCB,
    ...
    @acceptance-criteria @happy-path
    Scenario: Integration event uses Published Language
    ...
    @acceptance-criteria @happy-path
    Scenario: Schema compatibility mode is enforced
    ...
    @acceptance-criteria @validation
    Scenario: Unregistered event type fails conversion
  ...
  # ============================================================================
  # RULE 3: ACL Translates External Models
  # ============================================================================

  Rule: ACL translates external models
    ...
    **Verified by:** ACL translates external system response, ACL handles bidirectional translation,
    ...
    @acceptance-criteria @happy-path
    Scenario: ACL translates external system response
    ...
    @acceptance-criteria @happy-path
    Scenario: ACL handles bidirectional translation
    ...
    @acceptance-criteria @validation
    Scenario: ACL validates external input
    ...
    @acceptance-criteria @validation
    Scenario: ACL rejects unmapped values
