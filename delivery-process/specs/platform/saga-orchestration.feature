...
@libar-docs-depends-on:CommandBusFoundation,BoundedContextFoundation
  ...
  **Note:** This pattern was implemented before the delivery process existed
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Order Fulfillment Saga workflow | complete | examples/order-management/convex/sagas/orderFulfillment.ts |
      | Saga registry (startSagaIfNotExists) | complete | examples/order-management/convex/sagas/registry.ts |
      | Saga table schema | complete | examples/order-management/convex/schema.ts |
      | Event routing (OrderSubmitted -> Saga) | complete | examples/order-management/convex/sagas/router.ts |
      | @convex-dev/workflow integration | complete | examples/order-management/convex/infrastructure.ts |
      | Stock reservation step | complete | examples/order-management/convex/sagas/orderFulfillment.ts |
      | Compensation logic (order cancellation) | complete | examples/order-management/convex/sagas/orderFulfillment.ts |
      | onComplete callback handler | complete | examples/order-management/convex/sagas/completion.ts |
      | Saga admin functions | complete | examples/order-management/convex/sagas/admin.ts |
