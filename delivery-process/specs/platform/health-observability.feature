...
@libar-docs-pattern:HealthObservability
@libar-docs-status:roadmap
@libar-docs-phase:18b-2
@libar-docs-effort:1w
@libar-docs-product-area:Platform
@libar-docs-business-value:production-monitoring-and-k8s-integration
@libar-docs-depends-on:EventReplayInfrastructure,WorkpoolPartitioningStrategy
@libar-docs-executable-specs:platform-core/tests/features/behavior/health-observability
  ...
  **Convex Constraints:**
  ...
  Rule: Health endpoints support Kubernetes probes
    ...
    **Implementation via httpAction:**
    ...
    Scenario: Readiness probe returns healthy when all components OK
    ...
    Scenario: Readiness probe returns unhealthy on projection lag
    ...
    @acceptance-criteria @happy-path
    Scenario: Liveness probe always returns alive
  ...
  # ===========================================================================
  # RULE 2: Workpool Backlog Detection
  # ===========================================================================

  Rule: Workpool queue depth signals backpressure
    ...
    **Queue Depth Query:**
    ...
    @acceptance-criteria @validation
    Scenario: Workpool backlog fails readiness
    ...
    @acceptance-criteria @happy-path
    Scenario: Normal queue depth passes readiness
  ...
  # ===========================================================================
  # RULE 3: Projection Lag Metrics
  # ===========================================================================

  Rule: Projection lag tracks distance from Event Store head
    ...
    **Lag Thresholds:**
    ...
    @acceptance-criteria @happy-path
    Scenario: Projection lag is calculated correctly
    ...
    @acceptance-criteria @validation
    Scenario: Missing checkpoint treated as maximum lag
      Given Event Store max globalPosition is 1000
  ...
  # ===========================================================================
  # RULE 4: Metrics Collection for Log Streams
  # ===========================================================================

  Rule: Metrics are collected as structured JSON for Log Streams export
    ...
    **Scheduled Collection:**
    ...
    @acceptance-criteria @happy-path
    Scenario: Metrics collection gathers all dimensions
    ...
    @acceptance-criteria @happy-path
    Scenario: Metrics emitted as JSON for Log Streams
    ...
    @acceptance-criteria @validation
    Scenario: Metrics collection handles empty state
  ...
  # ===========================================================================
  # RULE 5: Component Health Aggregation
  # ===========================================================================

  Rule: System health aggregates component statuses
    ...
    **Component Health Checks:**
    ...
    @acceptance-criteria @happy-path
    Scenario: All components healthy yields healthy system
    ...
    @acceptance-criteria @validation
    Scenario: Single unhealthy component makes system unhealthy
      Given Event Store responds successfully
    ...
    @acceptance-criteria @validation
    Scenario: Degraded component yields degraded system
      Given Event Store responds successfully
