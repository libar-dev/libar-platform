# ADR-036: ADR 036 Projection Pool Split Named Pools Per Concern

**Purpose:** Architecture decision record for ADR 036 Projection Pool Split Named Pools Per Concern
