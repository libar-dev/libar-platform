# ADR-005: PDR 005 Mvp Workflow

**Purpose:** Architecture decision record for PDR 005 Mvp Workflow
...
| completed | complete     | Hard-locked  | All deliverables done, tests pass  |
