# ADR-014: PDR 014 Component Boundary Authentication Convention

**Purpose:** Architecture decision record for PDR 014 Component Boundary Authentication Convention
