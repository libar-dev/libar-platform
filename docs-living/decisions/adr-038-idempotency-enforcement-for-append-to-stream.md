# ADR-038: ADR 038 Idempotency Enforcement For Append To Stream

**Purpose:** Architecture decision record for ADR 038 Idempotency Enforcement For Append To Stream
