...
**Purpose:** Detailed patterns for CodecDrivenReferenceGeneration
...
- Given ADR-006 is tagged with "@architect-convention:fsm-rules"
- And ADR-004 is tagged with "@architect-convention:testing-policy"
...
- When checking for "@architect-convention"
