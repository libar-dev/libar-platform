...
- [`progress.ts`](../../libar-platform/packages/platform-core/src/projections/replay/progress.ts) - Progress calculation utilities for replay operations.
- [`types.ts`](../../libar-platform/packages/platform-core/src/projections/replay/types.ts) - Types for event replay and projection rebuilding.
