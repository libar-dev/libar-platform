...
**Purpose:** Detailed requirements for the Command Bus Foundation feature
...
- Command table schema (commandId, status, result, TTL) (complete)
- Command-Event correlations table (complete)
- recordCommand API (complete)
- updateCommandResult API (complete)
- getCommandStatus API (complete)
- getByCorrelation API (complete)
- cleanupExpired API (complete)
- CommandBus client wrapper (complete)
- CommandOrchestrator (7-step pattern) (complete)
- Middleware pipeline infrastructure (complete)
- Correlation chain utilities (complete)
