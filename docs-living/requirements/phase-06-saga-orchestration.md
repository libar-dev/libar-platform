...
**Purpose:** Detailed requirements for the Saga Orchestration feature
...
- Order Fulfillment Saga workflow (complete)
- Saga registry (startSagaIfNotExists) (complete)
- Saga table schema (complete)
- Event routing (OrderSubmitted -> Saga) (complete)
- @convex-dev/workflow integration (complete)
- Stock reservation step (complete)
- Compensation logic (order cancellation) (complete)
- onComplete callback handler (complete)
- Saga admin functions (complete)
