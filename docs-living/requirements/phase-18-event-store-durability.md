...
- [`durableAppend.ts`](../../libar-platform/packages/platform-core/src/durability/durableAppend.ts) - ## Durable Append via Workpool Actions
- [`idempotentAppend.ts`](../../libar-platform/packages/platform-core/src/durability/idempotentAppend.ts) - ## Idempotent Event Append
- [`index.ts`](../../libar-platform/packages/platform-core/src/durability/index.ts) - ## Event Store Durability
- [`intentCompletion.ts`](../../libar-platform/packages/platform-core/src/durability/intentCompletion.ts) - ## Intent/Completion Event Pattern
- [`outbox.ts`](../../libar-platform/packages/platform-core/src/durability/outbox.ts) - ## Outbox Pattern for Action Results
- [`poisonEvent.ts`](../../libar-platform/packages/platform-core/src/durability/poisonEvent.ts) - ## Poison Event Handling
- [`publication.ts`](../../libar-platform/packages/platform-core/src/durability/publication.ts) - ## Durable Cross-Context Event Publication
- [`types.ts`](../../libar-platform/packages/platform-core/src/durability/types.ts) - ## Event Store Durability Types
