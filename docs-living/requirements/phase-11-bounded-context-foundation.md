...
**Purpose:** Detailed requirements for the Bounded Context Foundation feature
...
- BoundedContextIdentity interface (complete)
- DualWriteContextContract interface (complete)
- Type helpers (ExtractCommandTypes, ExtractEventTypes, ExtractCMSTableNames) (complete)
- CMSTypeDefinition interface (complete)
- CommandTypeDefinition interface (complete)
- EventTypeDefinition interface (complete)
- ProcessManagerDefinition interface (complete)
- Result helpers (success, rejected) (complete)
- Component isolation documentation (complete)
